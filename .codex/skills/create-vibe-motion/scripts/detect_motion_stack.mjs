  ...
  .map((relPath) => {
    ...
    return {
      ...
      engines: {
        ...
        remotionTransitions: has("@remotion/transitions"),
        remotionShapes: has("@remotion/shapes"),
        remotionPaths: has("@remotion/paths"),
        remotionCaptions: has("@remotion/captions"),
        remotionMediaUtils: has("@remotion/media-utils"),
        react: has("react"),
        vite: has("vite"),
        gsap: has("gsap"),
        three: has("three"),
        ...
        pixi: has("pixi.js"),
        matter: has("matter-js"),
        noise: has("simplex-noise"),
        color: has("culori"),
      },
    };
  })
