...
Use this skill as the text style and expression-optimization layer in the VideoMaking workflow. It adapts the Nuwa-style idea from `https://github.com/alchaincyf/nuwa-skill`: distill reusable expression DNA from source material, then apply it to concrete copy.
...
```bash
pnpm run darwin:capture -- --target .codex/skills/nuwa-text-refiner/SKILL.md --domain copy --lesson "Reusable style/refinement lesson" --evidence "What proved it"
```
